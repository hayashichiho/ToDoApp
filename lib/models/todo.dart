...
class Todo {
  ...
  Todo({
    ...
    this.colorValue = 0xFF0000FF, // 初期色は青色
  }) : id = id ?? const Uuid().v4(); // IDが指定されない場合はUUIDを生成
  ...
  Todo copyWith({
    ...
    return Todo(
      ...
      colorValue: colorValue ?? this.colorValue, // 新しい色 or 元の色
    );
  }
}
